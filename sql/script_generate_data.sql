...
INSERT INTO config VALUES
    ...
    ('MACHINE_SUPPLIES_COUNT', '1200000'),
    ('MACHINE_CONDITIONS_COUNT', '1000000'),
    ('VENDING_POINT_SCHEDULES_COUNT', '80000'),
    ('VENDING_POINT_UNUSUAL_SCHEDULES_COUNT', '60000'),
    ('FUNCTION_VARIANTS_COUNT', '100000'),
    ('VENDING_POINTS_COUNT', '2000'),
    ('MACHINES_COUNT', '8000'),
    ('SCAN_TASKS_COUNT', '400000'),
    ('PRINT_TASKS_COUNT', '400000'),
    ('FILES_COUNT', '200000'),
    ('SCAN_TASK_FILES_COUNT', '120000'),
    ('PRINT_TASK_FILES_COUNT', '120000'),
    ('MACHINE_FILES_COUNT', '40000'),
    ('DAYS_BACK', '730'),
    ('RECENT_DAYS', '30');
