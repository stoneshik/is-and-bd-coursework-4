...
INSERT INTO config VALUES
    ...
    ('MACHINES_COUNT', '2000'),
    ('FUNCTION_VARIANTS_COUNT', '5000'),
    ('SCHEDULES_COUNT', '2000'),
    ('UNUSUAL_SCHEDULES_COUNT', '2000'),
    ('MACHINE_SUPPLIES_COUNT', '200000'),
    ('MACHINE_CONDITIONS_COUNT', '200000'),
    ('ORDERS_COUNT', '400000'),
    ('SCAN_TASKS_COUNT', '100000'),
    ('PRINT_TASKS_COUNT', '100000'),
    ('FILES_COUNT', '100000'),
    ('SCAN_TASK_FILES_COUNT', '50000'),
    ('PRINT_TASK_FILES_COUNT', '50000'),
    ('MACHINE_FILES_COUNT', '30000'),
    ('DAYS_BACK', '365'),
    ('RECENT_DAYS', '30');
